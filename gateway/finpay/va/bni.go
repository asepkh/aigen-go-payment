...
// BNIVARequest represents a request to create a BNI virtual account
type BNIVARequest struct {
...
// NewBNIVA creates a new BNI virtual account request from an invoice
func NewBNIVA(inv *invoice.Invoice) (*BNIVARequest, error) {

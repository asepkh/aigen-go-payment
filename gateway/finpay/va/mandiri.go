...
// MandiriVARequest represents a request to create a Mandiri virtual account
type MandiriVARequest struct {
...
// NewMandiriVA creates a new Mandiri virtual account request from an invoice
func NewMandiriVA(inv *invoice.Invoice) (*MandiriVARequest, error) {
